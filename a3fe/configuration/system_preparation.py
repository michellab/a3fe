"""system preparation for Pydantic configuration"""

__all__ = ["SystemPreparationConfig"]
...
# from ..run._utils import check_has_wat_and_box as _check_has_wat_and_box
...
class SystemPreparationConfig(_BaseModel):
    ...
    ion_conc: float = _Field(0.15, ge=0, lt=1)  # Metalll ion
